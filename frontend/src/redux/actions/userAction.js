...
import { USER_LOGIN_FAIL, USER_LOGIN_REQUEST, USER_LOGIN_SUCCESS, USER_LOGOUT, USER_REGISTER_FAIL, USER_REGISTER_REQUEST } from "../constants/userConstant"
...
export const register = (name, email, password) => async (dispatch) => {
    try {
        ...
        const { data } = axios.post(baseUrl + "users", { name, email, password }, config)
        dispatch({
            type: USER_LOGIN_SUCCESS,
            payload: data
        })
